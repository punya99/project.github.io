! function(e, n, t) {
    ...
    function a(e, t, o, a) {
        var r, f, l, d, u = "modernizr",
            ...
            h = i();
        if (parseInt(o, 10))
            for (; o--;) l = s("div"), l.id = a ? a[o] : u + (o + 1), p.appendChild(l);
    ...
    l.addTest("history", function() {
        ...
        return (-1 === n.indexOf("Android 2.") && -1 === n.indexOf("Android 4.0") || -1 === n.indexOf("Mobile Safari") || -1 !== n.indexOf("Chrome") || -1 !== n.indexOf("Windows Phone") || "file:" === location.protocol) && (e.history && "pushState" in e.history)
    });
    var p = function() {
        function e(e, n) {
            var i;
            return !!e && (n && "string" != typeof n || (n = s(n || "div")), e = "on" + e, i = e in n, !i && o && (n.setAttribute || (n = s("div")), n.setAttribute(e, ""), i = "function" == typeof n[e], n[e] !== t && (n[e] = t), n.removeAttribute(e)), i)
        }
        ...
        function() {
            ...
            for (var c in r)
                if (r.hasOwnProperty(c)) {
                    ...
                    for (s = o(n.fn, "function") ? n.fn() : n.fn, i = 0; i < e.length; i++) a = e[i], f = a.split("."), 1 === f.length ? l[f[0]] = s : (!l[f[0]] || l[f[0]] instanceof Boolean || (l[f[0]] = new Boolean(l[f[0]])), l[f[0]][f[1]] = s), d.push((s ? "" : "no-") + f.join("-"))
                }
        }(),
        function(e) {
            var n = c.className,
            ...
            l._config.enableClasses && (n += " " + t + e.join(" " + t), u ? c.className.baseVal = n : c.className = n)
